...
def run_strategy():
    """执行 run.py 脚本"""
    python_exe = r"H:\lzc_python\python.exe"
    script_path = r"H:\Quant_Proj\LZCTrader\run.py"
    subprocess.Popen([python_exe, script_path], cwd=r"H:\Quant_Proj\LZCTrader")
...
def schedule_runner():
    """定时检测，到点自动启动 run.py"""
    start_times = [(9, 10), (21, 10)]  # 仅保留启动时间 (小时, 分钟)
